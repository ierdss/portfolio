...
export const TechnologiesSectionHeading = {
    ...
    description:"As a Software Developer I have decided to master a small set of skills. Nonetheless, I am openly willing to learn new technologies to give more value to clients and to build myself even further.",
}
