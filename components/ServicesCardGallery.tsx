...
export default function ServicesCardGallery() {
    return(
        <div className='w-full grid grid-cols-2 grid-rows-6 grid-flo gap-4 py-12 md:py-16'>
            <ServiceCard 
                icon={content[0].icon} 
            ...
            />
            <div className='flex items-center justify-center text-transparent'>Filler</div>
