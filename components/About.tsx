...
export default function About() {
  ...
  return (
    ...
    >
      <div className="relative flex w-full max-w-[1980px] flex-col items-center justify-center gap-[35px] px-[8px] py-[50px] md:flex-row md:gap-[70px] md:px-[150px] md:py-[200px]">
