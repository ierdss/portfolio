...
export default function About() {
  ...
  return (
    <div
      id="about"
      className="sectionPadding w-full text-center flex justify-center items-center md:text-left flex-col md:flex-row md:min-h-[800px] relative overflow-hidden  max-w-screen-xl"
    >
