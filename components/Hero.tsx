  ...
  return (
    ...
    >
      <div className="flex w-full max-w-[1980px] flex-col justify-between gap-[50px] px-[8px] py-[50px] shadow-lg md:flex-row md:px-[150px] md:py-[100px]">
        <div className="relative flex h-[100vh] max-h-[800px] w-full max-w-[1980px] flex-col items-center justify-center gap-[40px] overflow-hidden  px-[8px] py-[50px] shadow-lg md:flex-row md:gap-[50px] md:px-[150px] md:py-[100px]">
          ...
          <div className="hero__headline">
            ...
            <p className="sectionLeading max-w-md !text-center md:!text-left">
              I specialize in constructing websites and mobile applications
              while immersing myself in diverse aspects of the digital spectrum
