...
export default function Testimonials() {
  return (
    ...
    >
      <div className="max-w-center relative flex w-full flex-col items-center justify-between gap-[35px] px-[8px] py-[50px] md:gap-[70px] md:px-[150px] md:py-[200px]">
  ...
  return (
    <ul className="z-20 flex flex-col items-start justify-center gap-[8px] md:flex-row md:gap-[40px]">
      {row.map(({ id, avatar, name, location, testimonial }) => (
        <li
          key={id}
          className="group relative flex w-full select-none flex-col items-center justify-start gap-[24px] rounded-[20px] bg-glass p-5 text-content transition-all duration-500 ease-in-out hover:-translate-y-1 md:min-h-[220px] md:w-[400px] md:p-10 md:hover:-translate-y-4"
        >
